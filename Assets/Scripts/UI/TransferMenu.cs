...
public class TransferMenu : MonoBehaviour
{
    ...
    public void createMenu(string hierarchyObject, Vector2 menuCenter, ChestInventory chestInventory)
    {

        itemCount = chestInventory.chestItems.Count;
        ...
        for (int i = 0; i < itemCount; i++)
        {
            ...
            chestMenuItemInstance.GetComponent<TransferMenuItem>().baseInfo = chestInventory.chestItems[i];
