...
public class LeanTweenDocumentationEditor : Editor {
	...
	[UnityEditor.MenuItem ("Help/LeanTween Documentation")]
	...
	[UnityEditor.MenuItem ("Help/LeanTween Forum (ask questions)")]
	...
	[UnityEditor.MenuItem ("Help/LeanTween GitHub (contribute code)")]
	static void openGit()
	{
		Application.OpenURL("https://github.com/dentedpixel/LeanTween");
	}

	[UnityEditor.MenuItem ("Help/LeanTween Support (donate)")]
	...
	[UnityEditor.MenuItem ("Help/Dented Pixel News")]
